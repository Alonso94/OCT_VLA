...
## Stage A: every arm (`videos/stage_a_all_arms/`)

Atomic-clip training, absolute EE; matrix prefix `F` in the result files.
...
## The chaining study: atomic clips vs full runs
...
### Atomic clips (`videos/chaining_atomic_clips/`, result prefix `AF`)
...
### Full runs (`videos/chaining_full_runs/`, result prefix `CF`)

| arm | setting | training seed | scene seed | meshes | transfers | lifted | success | row mean transfers (per seed) | video |
| --- | --- | ---: | ---: | --- | ---: | ---: | --- | --- | --- |
| rgb | 3 objects, seen identities | 1000 | 803 | seen | 1 | 2 | no | 0.80, 0.40, 0.90 | [rgb__three_seen.mp4](videos/chaining_full_runs/rgb__three_seen.mp4) |
| rgb | 3 objects, heldout identities | 1001 | 801 | heldout | 0 | 1 | no | 0.00, 0.05, 0.10 | [rgb__three_heldout.mp4](videos/chaining_full_runs/rgb__three_heldout.mp4) |
| rgb | 3 objects, novel identities | 1001 | 801 | novel | 0 | 1 | no | 0.10, 0.30, 1.85 | [rgb__three_novel.mp4](videos/chaining_full_runs/rgb__three_novel.mp4) |
| rgb | 2 objects, seen | 1002 | 804 | seen | 1 | 1 | no | 0.70, 1.05, 0.90 | [rgb__two.mp4](videos/chaining_full_runs/rgb__two.mp4) |
| rgb | 4 objects, seen | 1002 | 807 | seen | 1 | 2 | no | 0.45, 0.75, 0.55 | [rgb__four.mp4](videos/chaining_full_runs/rgb__four.mp4) |

## Regenerating

```bash
source ~/octvla/env-leftmost.sh
declare -A DEST=([F]=stage_a_all_arms [AF]=chaining_atomic_clips [CF]=chaining_full_runs)
for p in F AF CF; do
